"""
VI LiveKit Agent — backward-compatible shim.

All implementation has been refactored into the assistant/ package.
This module re-exports public names so existing imports continue to work.
"""
