...
echo -e "    ${GREEN}/team${NC}           — Onboard + dashboard"
echo -e "    ${GREEN}/create-mc${NC}      — Create MC and assign to member (Leader)"
echo -e "    ${GREEN}/get-mc${NC}         — View assigned MCs"
echo -e "    ${GREEN}/complete-mc${NC}    — Submit completed MC for review"
echo -e "    ${GREEN}/review-mc${NC}      — Review submitted MCs (Leader)"
echo ""
...
echo -e "    ${CYAN}/team${NC}                      → onboard + dashboard"
echo -e "    ${CYAN}/get-mc${NC}                    → view assigned missions"
echo -e "    ${CYAN}/drive${NC}                     → execute with full autonomy"
echo -e "    ${CYAN}/complete-mc${NC}               → submit + PR + notify leader"
echo ""
